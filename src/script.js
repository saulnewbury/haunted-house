...
walls.geometry.setAttribute(
  'uv2',
  new THREE.Float32BufferAttribute(walls.geometry.computeVertexNormals.array, 2)
)
...
door.geometry.setAttribute(
  'uv2',
  new THREE.Float32BufferAttribute(door.geometry.computeVertexNormals.array, 2)
)
door.position.y = 1
...
for (let i = 0; i < 50; i++) {
  ...
  console.log(angle, Math.sin(angle), Math.cos(angle), radius)
...
floor.geometry.setAttribute(
  'uv2',
  new THREE.Float32BufferAttribute(floor.geometry.computeVertexNormals.array, 2)
)
